...
public:
  ...
  MCAPI virtual void _serverInitItemStackIds(void);
  MCAPI virtual void _doInitialMove(void);
  MCAPI virtual bool hasComponent(class HashedString const &) const;
  MCAPI virtual ~Actor();
  ...
  MCAPI virtual void checkBlockCollisions();
  MCAPI virtual bool isFireImmune(void) const;
  MCAPI virtual void breaksFallingBlocks() const;
  ...
  MCAPI virtual void teleportTo(class Vec3 const &, bool, int, int, struct ActorUniqueID const &);
  ...
  MCAPI virtual std::unique_ptr<class AddActorBasePacket> getAddPacket(void);
  ...
  MCAPI virtual bool canShowNameTag() const;
  MCAPI virtual bool canExistInPeaceful() const;
  MCAPI virtual void setNameTagVisible(bool);
  MCAPI virtual std::string const &getNameTag(void) const;
  MCAPI virtual unsigned __int64 getNameTagAsHash(void) const;
  ...
  MCAPI virtual bool getAlwaysShowNameTag() const;
  ...
  MCAPI virtual float getCameraOffset() const;
  ...
  MCAPI virtual bool canSeeInvisible() const;
  ...
  MCAPI virtual void interactPreventDefault();
  MCAPI virtual void playerTouch(Player &);
  ...
  MCAPI virtual void onTame();
  MCAPI virtual void onFailedTame();
  ...
  MCAPI virtual void rideJumped();
  MCAPI virtual void rideLanded(Vec3 const &, Vec3 const &);
  MCAPI virtual bool shouldRender(void) const;
  MCAPI virtual bool isInvulnerableTo(class ActorDamageSource const &) const;
  MCAPI virtual enum ActorDamageCause getBlockDamageCause(class Block const &) const;
  ...
  MCAPI virtual void onBounceStarted(BlockPos const &, BlockPos const &);
  MCAPI virtual void feed(int);
  MCAPI virtual void handleEntityEvent(enum ActorEvent, int);
  MCAPI virtual float getPickRadius();
  ...
  MCAPI virtual void awardKillScore(Actor &, int);
  ...
  MCAPI virtual ActorUniqueID getSourceUniqueID() const;
  ...
  MCAPI virtual bool canPickupItem(ItemStack const &) const;
  MCAPI virtual bool canBePulledIntoVehicle() const;
  MCAPI virtual bool inCaravan(void) const;
  MCAPI virtual bool isLeashableType();
  MCAPI virtual void tickLeash(void);
  MCAPI virtual void sendMotionPacketIfNeeded(void);
  MCAPI virtual bool canSynchronizeNewEntity() const;
  ...
  MCAPI virtual int getOutputSignal() const;
  ...
  MCAPI virtual float getYHeadRot() const;
  MCAPI virtual bool isWorldBuilder(void);
  MCAPI virtual bool isCreative() const;
  ...
  MCAPI virtual bool canDestroyBlock(Block const &) const;
  ...
  MCAPI virtual void stopSpinAttack();
  ...
  MCAPI virtual bool shouldTryMakeStepSound(void);
  MCAPI virtual float getNextStep(float);
  MCAPI virtual bool canMakeStepSound() const;
  ...
  MCAPI virtual void _makeFlySound() const;
  ...
  MCAPI virtual class LootTable *getLootTable();
  MCAPI virtual class LootTable *getDefaultLootTable();
  MCAPI virtual void _removeRider(struct ActorUniqueID const &, bool, bool, bool);
  MCAPI virtual void _onSizeUpdated(void);
  MCAPI virtual void _doAutoAttackOnTouch(Actor &);
